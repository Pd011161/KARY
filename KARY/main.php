    ...
    <body>
        ...
        <div class="container" style="margin-top: 200px;">
            ...
            <div class="list-group inp"  style="border: 1px solid rgba(255,255,255,0.1);">
                ...
                <a href="scansend.php" class="list-group-item list-group-item-action text-center" style="">scan-send</a>
                <a href="scanre.php" class="list-group-item list-group-item-action text-center">scan-receive</a>
